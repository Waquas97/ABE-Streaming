...
echo 'dest_domain=. scheme=http parent="10.10.1.2:80"' | sudo tee -a /opt/ts/etc/trafficserver/parent.config
echo 'dest_domain=. scheme=https parent="10.10.1.2:443"' | sudo tee -a /opt/ts/etc/trafficserver/parent.config

dest_domain=. scheme=https parent="10.10.1.2:443"
