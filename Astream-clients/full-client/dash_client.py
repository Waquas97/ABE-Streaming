...
def download_segment(segment_url, dash_folder, index_file=None):
    ...
    if "init" not in segment_filename:
        ...
        bashCommand="time cpabe-dec pub_key user_key "+str(segment_filename)+" -k"
        ...
        #print(segment_decryption_time,'client\n\n\n\n')
        ...
        #stdout_output = result.stdout.decode() #for terminal output other than timing

        #decryptor.start_decryption(segment_filename)
        #os._exit(1)
