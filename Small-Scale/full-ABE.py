...
def change_client_logs(node_id, cache_size, typerun):
    ssh_command = (
        ...
        f"'rm full-client1/log/*.m4* &&"
        f"mv full-client1/log/ full-client1/log-cache{cache_size}-{typerun} && "
        f"rm full-client2/log/*.m4* &&"
        f"mv full-client2/log/ full-client2/log-cache{cache_size}-{typerun} && "
        f"rm full-client3/log/*.m4* &&"
        f"mv full-client3/log/ full-client3/log-cache{cache_size}-{typerun} && "
        f"rm full-client4/log/*.m4* &&"
        f"mv full-client4/log/ full-client4/log-cache{cache_size}-{typerun} && "
        f"rm full-client5/log/*.m4* &&"
        f"mv full-client5/log/ full-client5/log-cache{cache_size}-{typerun} && "
        f"rm full-client6/log/*.m4* &&"
        f"mv full-client6/log/ full-client6/log-cache{cache_size}-{typerun} '"
    )
...
def run_program_on_node(node_ip, vid, clientnum, cache_size, typerun, clientpernode, lastnode_id):
    ...
    command = (
        f"ssh -y waquas97@{node_ip} 'cd full-client{clientnum} && "
...
#experiment 30clients
sleep_times=[24, 22, 21, 34, 42, 36, 38, 27, 26, 26, 25, 27, 27, 41, 30, 39, 22, 39, 26, 33, 38, 24, 41, 28, 27, 39, 28, 35, 32, 26]
selected_videos= ['BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy2.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy3.mpd', 'BigBuckBunny-Full-copy2.mpd', 'BigBuckBunny-Full-copy1.mpd', 'BigBuckBunny-Full-copy1.mpd', 'BigBuckBunny-Full-copy1.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full-copy3.mpd', 'BigBuckBunny-Full-copy2.mpd', 'BigBuckBunny-Full-copy1.mpd', 'BigBuckBunny-Full-copy1.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full-copy2.mpd', 'BigBuckBunny-Full-copy4.mpd', 'BigBuckBunny-Full.mpd', 'BigBuckBunny-Full-copy2.mpd', 'BigBuckBunny-Full-copy2.mpd']
...
cache_sizes=[0,10,100,250,500,1000,1500,2000] #CACHES SIZES PAPER
#cache_sizes=[0]
