...
def change_client_logs(node_id, cache_size, typerun):
    ssh_command = (
        ...
        f"'rm https-client1/log/*.m4s &&"
        f"mv https-client1/log/ https-client1/log-cache{cache_size}-{typerun} && "
        f"rm https-client2/log/*.m4s &&"
        f"mv https-client2/log/ https-client3/log-cache{cache_size}-{typerun} && "
        f"rm https-client3/log/*.m4s &&"
        f"mv https-client3/log/ https-client2/log-cache{cache_size}-{typerun} && "
        f"rm https-client4/log/*.m4s &&"
        f"mv https-client4/log/ https-client4/log-cache{cache_size}-{typerun} && "
        f"rm https-client5/log/*.m4s &&"
        f"mv https-client5/log/ https-client5/log-cache{cache_size}-{typerun} &&"
        f"rm https-client6/log/*.m4s &&"
        f"mv https-client6/log/ https-client6/log-cache{cache_size}-{typerun} '"
    )
...
def run_program_on_node(node_ip, vid, clientnum, cache_size, typerun, clientpernode, lastnode_id):
    ...
    command = (
        f"ssh -y waquas97@{node_ip} 'cd https-client{clientnum} && "
...
selected_videos= ['original.mpd', 'original-copy2.mpd', 'original.mpd', 'original-copy4.mpd', 'original.mpd', 'original-copy4.mpd', 'original.mpd', 'original-copy3.mpd', 'original-copy2.mpd', 'original-copy1.mpd', 'original-copy1.mpd', 'original-copy1.mpd', 'original.mpd', 'original-copy4.mpd', 'original-copy4.mpd', 'original-copy4.mpd', 'original-copy4.mpd', 'original-copy3.mpd', 'original-copy2.mpd', 'original-copy1.mpd', 'original-copy1.mpd', 'original-copy4.mpd', 'original.mpd', 'original.mpd', 'original-copy4.mpd', 'original-copy2.mpd', 'original-copy4.mpd', 'original.mpd', 'original-copy2.mpd', 'original-copy2.mpd']
...
# cd
# cd https-client
# python dash_client.py -m https://10.10.1.2/original.mpd -p basic -d