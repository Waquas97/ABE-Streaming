...
def change_client_logs(node_id, cache_size, typerun):
    ssh_command = (
        ...
        f"'rm 360-SE-client1/log/*.m4* &&"
        f"mv 360-SE-client1/log/ 360-SE-client1/log-cache{cache_size}-{typerun} && "
        f"rm 360-SE-client2/log/*.m4* &&"
        f"mv 360-SE-client2/log/ 360-SE-client2/log-cache{cache_size}-{typerun} && "
        f"rm 360-SE-client3/log/*.m4* &&"
        f"mv 360-SE-client3/log/ 360-SE-client3/log-cache{cache_size}-{typerun} && "
        f"rm 360-SE-client4/log/*.m4* &&"
        f"mv 360-SE-client4/log/ 360-SE-client4/log-cache{cache_size}-{typerun} && "
        f"rm 360-SE-client5/log/*.m4* &&"
        f"mv 360-SE-client5/log/ 360-SE-client5/log-cache{cache_size}-{typerun} && "
        f"rm 360-SE-client6/log/*.m4* &&"
        f"mv 360-SE-client6/log/ 360-SE-client6/log-cache{cache_size}-{typerun} '"
    )
...
def run_program_on_node(node_ip, vid, clientnum, cache_size, typerun, clientpernode, lastnode_id):
    ...
    command = (
        f"ssh -y waquas97@{node_ip} 'cd 360-SE-client{clientnum} && "
        f"python dash_client.py -m http://10.10.1.2/{vid} -p basic -d '"
    )
...
#selected_videos= ['help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy2.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy3.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy2.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy1.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy1.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy1.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy3.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy2.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy1.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy1.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy2.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy4.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy2.mpd', 'help360-SE-ABE-MajorP-MinorI-4tiles-copy2.mpd']
selected_videos= ['help360-SE-ABE-MajorP-MinorI-4tiles-1.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-2.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-3.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-4.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-5.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-6.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-7.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-8.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-9.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-10.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-11.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-12.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-13.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-14.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-15.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-16.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-17.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-18.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-19.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-20.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-21.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-22.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-23.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-24.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-25.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-26.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-27.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-28.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-29.mpd','help360-SE-ABE-MajorP-MinorI-4tiles-30.mpd']
...
# cd client
# python dash_client.py -m http://10.10.1.2/BigBuckBunny-Full.mpd -p basic -d
