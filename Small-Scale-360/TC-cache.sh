...
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1: classid 1:1 htb rate 480mbit
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1:1 classid 1:11 htb rate 72mbit
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1:1 classid 1:12 htb rate 72mbit
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1:1 classid 1:13 htb rate 72mbit
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1:1 classid 1:14 htb rate 72mbit
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1:1 classid 1:15 htb rate 72mbit
sudo tc class add dev $(ifconfig | grep -o 'enp[^:]*') parent 1:1 classid 1:16 htb rate 120mbit
