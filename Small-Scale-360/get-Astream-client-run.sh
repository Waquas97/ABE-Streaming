...
wget -L https://raw.githubusercontent.com/Waquas97/ABE-Streaming/master/Small-Scale-360/https-client.tax.xz
tar -xf https-client.tar.xz
rm https-client.tar.xz

# Get Astream DASH client
wget -L https://raw.githubusercontent.com/Waquas97/ABE-Streaming/master/Small-Scale-360/full-client.tax.xz
